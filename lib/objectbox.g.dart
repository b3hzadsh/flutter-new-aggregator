  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    NewsItem: obx_int.EntityDefinition<NewsItem>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final isPriorityParam = const fb.BoolReader().vTableGet(
          buffer,
          rootOffset,
          22,
          false,
...
class NewsItem_ {
  ...
  static final remoteId = obx.QueryStringProperty<NewsItem>(
    _entities[0].properties[1],
  );

  /// See [NewsItem.title].
  static final title = obx.QueryStringProperty<NewsItem>(
    _entities[0].properties[2],
  );

  /// See [NewsItem.content].
  static final content = obx.QueryStringProperty<NewsItem>(
    _entities[0].properties[3],
  );

  /// See [NewsItem.summary].
  static final summary = obx.QueryStringProperty<NewsItem>(
    _entities[0].properties[4],
  );

  /// See [NewsItem.imageUrl].
  static final imageUrl = obx.QueryStringProperty<NewsItem>(
    _entities[0].properties[5],
  );

  /// See [NewsItem.sourceName].
  static final sourceName = obx.QueryStringProperty<NewsItem>(
    _entities[0].properties[6],
  );

  /// See [NewsItem.publishDate].
  static final publishDate = obx.QueryDateProperty<NewsItem>(
    _entities[0].properties[7],
  );

  /// See [NewsItem.isRead].
  static final isRead = obx.QueryBooleanProperty<NewsItem>(
